...
/**está pegando os dados de login, senha e entrar**/
  ...
  $connect = mysqli_connect('localhost','root','digitesenha','estagio'); /**local q está o banco, nome root, senha do root, e nome do banco**/
    if (isset($entrar)) {
      ...
      $verifica = mysqli_query($connect, "SELECT * FROM usuario WHERE login = '$login' AND senha = '$senha'") or die("erro ao selecionar"); /**aqui estou selecionando a tabela com o login e a senha, se não tiver, ele vai dar erro**/
