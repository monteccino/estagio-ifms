...
$connect = mysqli_connect('localhost','root','digitesenha','estagio');  /**local q está o banco, nome root, senha do root, e nome do banco**/
$query_select = "SELECT login FROM usuario WHERE login = '$login'"; /**selecionando qual tabela usar**/
...
$logarray = $array['login'];
      ...
      if($logarray == $login){ 
        ...
        $query = "INSERT INTO usuario(login,senha) VALUES ('$login','$senha')"; /** aqui ele está adicionando os valores que foi pedido**/
